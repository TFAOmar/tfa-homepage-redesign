      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="space-y-6">
          {result ? (
            ...
            <Card className="bg-slate-900/80 backdrop-blur-xl border-white/20 shadow-xl shadow-black/40 rounded-2xl">
              <div className="pt-12 pb-12 text-center px-6">
                <div className="max-w-md mx-auto space-y-4">
                  <div className="w-16 h-16 bg-primary/20 rounded-full flex items-center justify-center mx-auto">
                    <Target className="w-8 h-8 text-primary" />
                  </div>
                  <h3 className="text-xl font-bold text-white">Ready to Plan Your Future?</h3>
                  <p className="text-white/70">
                    Fill out the form and click Calculate to see how much you need to save.
                  </p>
                </div>
              </div>
            </Card>
