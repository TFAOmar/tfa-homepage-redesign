...
import EricaValenzuelaLivingTrustForm from "@/components/living-trust/EricaValenzuelaLivingTrustForm";
import tfaLogo from "@/assets/tfa-logo.png";
import ericaPhoto from "@/assets/advisors/erica-valenzuela.jpg";
import { SEOHead, JsonLd } from "@/components/seo";
import { generateWebPageSchema, generateBreadcrumbSchema, generatePersonSchema } from "@/lib/seo/schemas";
import { siteConfig } from "@/lib/seo/siteConfig";

export default function EricaValenzuelaLivingTrust() {
  const scrollToForm = () => {
  ...
  const steps = [
    ...
    {
      number: "2",
      title: "Erica Contacts You",
      description: "Within 24-48 hours, Erica will reach out to discuss your needs.",
    },
    {
      number: "3",
  ...
  return (
    <>
      <SEOHead
        title="Living Trust Planning with Erica Valenzuela"
        description="Protect your family's future with a Living Trust. Erica Valenzuela specializes in helping families in high-stress professions plan for the unexpected."
        canonical={`${siteConfig.url}/advisors/erica-valenzuela/living-trust`}
        keywords="living trust, estate planning, avoid probate, Erica Valenzuela, asset protection, corrections, first responders, bilingual"
      />
      <JsonLd
        data={[
          generateWebPageSchema(
            ...
            `${siteConfig.url}/advisors/erica-valenzuela/living-trust`
          ),
          generateBreadcrumbSchema([
            { name: "Home", url: siteConfig.url },
            { name: "Advisors", url: `${siteConfig.url}/advisors` },
            { name: "Erica Valenzuela", url: `${siteConfig.url}/advisors/erica-valenzuela` },
            { name: "Living Trust", url: `${siteConfig.url}/advisors/erica-valenzuela/living-trust` },
          ]),
          generatePersonSchema(
            "Erica Valenzuela",
            "Financial Strategist",
            "Erica Valenzuela specializes in Living Trust awareness and protection planning for families in demanding careers.",
            `${siteConfig.url}/assets/advisors/erica-valenzuela.jpg`,
            `${siteConfig.url}/advisors/erica-valenzuela/living-trust`,
            ["Living Trust", "Estate Planning", "Life Insurance", "Real Estate"]
          ),
        ]}
      />
      <div className="min-h-screen bg-gradient-to-b from-primary via-primary-dark to-primary">
        ...
        <header className="py-4 md:py-6 px-3 md:px-4 bg-white border-b border-gray-100">
          ...
          <p className="text-center text-muted-foreground text-xs md:text-sm mt-2 md:mt-3 tracking-wide">
            Protecting Families in High-Stress Professions
          </p>
        </header>
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className="text-center md:text-left order-2 md:order-1">
                ...
                <p className="text-base md:text-lg lg:text-xl text-white/70 mb-6 md:mb-8 leading-relaxed">
                  Planning for the unexpected is the greatest gift you can give your family. Learn how a Living Trust can protect your assets and your loved ones.
                </p>
                <Button
              ...
              <div className="flex justify-center order-1 md:order-2">
                <div className="relative">
                  ...
                  <div className="relative bg-white/10 backdrop-blur-xl rounded-xl md:rounded-2xl border border-white/15 p-4 md:p-6 lg:p-8">
                    <img
                      src={ericaPhoto}
                      alt="Erica Valenzuela"
                      className="w-36 h-36 md:w-48 md:h-48 lg:w-56 lg:h-56 rounded-lg md:rounded-xl object-cover mx-auto mb-3 md:mb-4"
                    />
                    <div className="text-center">
                      <h3 className="text-lg md:text-xl font-semibold text-white">Erica Valenzuela</h3>
                      <p className="text-accent font-medium text-sm md:text-base">Financial Strategist</p>
                      <p className="text-amber-400 text-xs md:text-sm mt-1">Bilingual • Bilingüe</p>
                      <p className="text-white/60 text-xs md:text-sm mt-1 md:mt-2">Notary • Real Estate • Life License</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-white/10 backdrop-blur-xl rounded-xl md:rounded-2xl border border-white/15 p-6 md:p-8 lg:p-12">
              ...
              <p className="text-white/70 leading-relaxed mb-4 md:mb-6 text-sm md:text-base">
                With a background in corrections, Erica understands the realities of high-stress professions 
                and the importance of planning for the unexpected. As a licensed Notary, Real Estate Professional, 
                and Life Insurance Specialist, she brings a unique, well-rounded perspective to protection planning—
                bridging real estate, life insurance, and estate awareness into a cohesive strategy for families 
                who need their plan to work when it counts.
              </p>
        ...
        <section id="consultation-form" className="py-12 md:py-16 lg:py-20 px-4 bg-white/5 scroll-mt-4">
          <div className="max-w-xl md:max-w-2xl mx-auto">
            <EricaValenzuelaLivingTrustForm />
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 lg:py-20 px-4 bg-white/5">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white/70 mb-6 md:mb-8 max-w-2xl mx-auto text-sm md:text-base">
              ...
              with Erica today and take the first step toward peace of mind.
            </p>
            <Button
              onClick={scrollToForm}
            ...
            <div className="mt-8 md:mt-12 flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 text-white/60">
              ...
              <a href="mailto:evalenzuela@tfainsuranceadvisors.com" className="flex items-center gap-2 hover:text-accent transition-colors min-h-[44px] touch-manipulation text-sm md:text-base break-all md:break-normal">
                ...
                <span>evalenzuela@tfainsuranceadvisors.com</span>
              </a>
            </div>
          </div>
        </section>
