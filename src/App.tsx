...
import AdvisorRubenDavis from "./pages/AdvisorRubenDavis";
import AdvisorMichelleMartinez from "./pages/AdvisorMichelleMartinez";
...
import AdvisorRosieNuno from "./pages/AdvisorRosieNuno";
import AdvisorAileenGutierrez from "./pages/AdvisorAileenGutierrez";
import AdvisorKristinRomo from "./pages/AdvisorKristinRomo";
...
import EstatePlanningES from "./pages/EstatePlanningES";
...
import AileenGutierrezReferral from "./pages/AileenGutierrezReferral";
import AileenPartnerProgram from "./pages/AileenPartnerProgram";
import OmarConnect from "./pages/OmarConnect";
import HomeownerProtection from "./pages/HomeownerProtection";
import OmarReferralPrequalification from "./pages/OmarReferralPrequalification";
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <Routes>
          ...
          <Route path="/advisors/manuel-soto/escobar-realty" element={<EscobarRealtyLivingTrust />} />
          ...
          <Route path="/advisors/joseph-guzman" element={<AdvisorJosephGuzman />} />
          ...
          <Route path="/advisors/kevin-walters" element={<AdvisorKevinWalters />} />
          <Route path="/advisors/ruben-davis" element={<AdvisorRubenDavis />} />
          <Route path="/advisors/michelle-martinez" element={<AdvisorMichelleMartinez />} />
          <Route path="/advisors/cayla-dee-porter" element={<AdvisorCaylaDeePorter />} />
          <Route path="/advisors/merriane-mcguire" element={<AdvisorMerrianeMcGuire />} />
          <Route path="/advisors/elizabeth-rocha" element={<AdvisorElizabethRocha />} />
          <Route path="/advisors/rosie-nuno" element={<AdvisorRosieNuno />} />
          <Route path="/advisors/aileen-gutierrez" element={<AdvisorAileenGutierrez />} />
          <Route path="/advisors/kristin-romo" element={<AdvisorKristinRomo />} />
          ...
          <Route path="/es/services/estate-planning" element={<EstatePlanningES />} />
