import { Shield, FileText, Lock, Heart, ArrowDown, Phone, Mail, Home } from "lucide-react";
import { Button } from "@/components/ui/button";
import BraihyraLivingTrustForm from "@/components/living-trust/BraihyraLivingTrustForm";
import tfaLogo from "@/assets/tfa-logo.png";
import braihyraPhoto from "@/assets/advisors/braihyra-medellin.jpg";
import { SEOHead, JsonLd } from "@/components/seo";
import { generateWebPageSchema, generateBreadcrumbSchema, generatePersonSchema } from "@/lib/seo/schemas";
import { siteConfig } from "@/lib/seo/siteConfig";

export default function BraihyraLivingTrust() {
  const scrollToForm = () => {
  ...
  const steps = [
    ...
    {
      number: "2",
      title: "Braihyra Contacts You",
      description: "Within 24-48 hours, Braihyra will reach out to discuss your needs.",
    },
    {
      number: "3",
  ...
  return (
    <>
      <SEOHead
        title="Living Trust Planning with Braihyra Medellin"
        ...
        canonical={`${siteConfig.url}/advisors/braihyra-medellin/living-trust`}
        keywords="living trust, estate planning, avoid probate, Braihyra Medellin, asset protection, Big Moves Financial"
      />
      <JsonLd
        data={[
          generateWebPageSchema(
            ...
            `${siteConfig.url}/advisors/braihyra-medellin/living-trust`
          ),
          generateBreadcrumbSchema([
            { name: "Home", url: siteConfig.url },
            { name: "Advisors", url: `${siteConfig.url}/advisors` },
            { name: "Braihyra Medellin", url: `${siteConfig.url}/advisors/braihyra-medellin` },
            { name: "Living Trust", url: `${siteConfig.url}/advisors/braihyra-medellin/living-trust` },
          ]),
          generatePersonSchema(
            "Braihyra Medellin",
            "Financial Strategist",
            "Braihyra Medellin specializes in Living Trust consultations and asset protection.",
            `${siteConfig.url}/assets/advisors/braihyra-medellin.jpg`,
            `${siteConfig.url}/advisors/braihyra-medellin/living-trust`,
            ["Living Trust", "Estate Planning", "Asset Protection", "Real Estate Solutions"]
          ),
        ]}
      />
        ...
        <header className="py-4 md:py-6 px-3 md:px-4 bg-white border-b border-gray-100">
          <div className="max-w-6xl mx-auto flex items-center justify-center gap-4 md:gap-6 lg:gap-10">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-primary text-sm md:text-base lg:text-lg">Big Moves Financial</span>
            </div>
          </div>
          <p className="text-center text-muted-foreground text-xs md:text-sm mt-2 md:mt-3 tracking-wide">
            Powered by The Financial Architects
          </p>
        </header>
              ...
              <div className="flex justify-center order-1 md:order-2">
                <div className="relative">
                  ...
                  <div className="relative bg-white/10 backdrop-blur-xl rounded-xl md:rounded-2xl border border-white/15 p-4 md:p-6 lg:p-8">
                    <img
                      src={braihyraPhoto}
                      alt="Braihyra Medellin"
                      className="w-36 h-36 md:w-48 md:h-48 lg:w-56 lg:h-56 rounded-lg md:rounded-xl object-cover mx-auto mb-3 md:mb-4"
                    />
                    <div className="text-center">
                      <h3 className="text-lg md:text-xl font-semibold text-white">Braihyra Medellin</h3>
                      <p className="text-accent font-medium text-sm md:text-base">Financial Strategist</p>
                      <p className="text-amber-400 text-xs md:text-sm mt-1">Licensed Realtor</p>
                      <p className="text-white/60 text-xs md:text-sm mt-1 md:mt-2">Big Moves Financial</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-white/10 backdrop-blur-xl rounded-xl md:rounded-2xl border border-white/15 p-6 md:p-8 lg:p-12">
              ...
              <p className="text-white/70 leading-relaxed mb-4 md:mb-6 text-sm md:text-base">
                As both a Financial Strategist and Licensed Realtor, Braihyra brings a unique perspective 
                to Living Trust planning. She understands how real estate, assets, and family dynamics 
                intersect—and creates comprehensive strategies that protect everything you've worked hard to build.
              </p>
              <p className="text-accent font-semibold italic text-base md:text-lg">
                "True wealth is about more than money—it's about peace of mind and legacy."
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 lg:py-20 px-4 bg-white/5">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white/70 mb-6 md:mb-8 max-w-2xl mx-auto text-sm md:text-base">
              ...
              with Braihyra today and take the first step toward peace of mind.
            </p>
            <Button
              onClick={scrollToForm}
            ...
            <div className="mt-8 md:mt-12 flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 text-white/60">
              <a href="tel:+15627023369" className="flex items-center gap-2 hover:text-accent transition-colors min-h-[44px] touch-manipulation">
                <Phone className="w-5 h-5" />
                <span>(562) 702-3369</span>
              </a>
              <span className="hidden md:inline text-white/30">|</span>
              <a href="mailto:bri@tfainsuranceadvisors.com" className="flex items-center gap-2 hover:text-accent transition-colors min-h-[44px] touch-manipulation text-sm md:text-base break-all md:break-normal">
          ...
          <div className="max-w-6xl mx-auto text-center">
            <div className="flex items-center justify-center gap-3 md:gap-4 mb-3 md:mb-4">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="font-medium text-primary text-sm">Big Moves Financial</span>
              </div>
            </div>
