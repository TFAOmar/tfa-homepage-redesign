...
const Locations = () => {
  ...
  // Generate LocalBusiness schemas for all 33 locations
  ...
  return (
    <>
      <SEOHead
        ...
        description="Find a The Financial Architects office near you. 33 locations across California, Arizona, and Oregon including Los Angeles, San Diego, Orange County, and Phoenix."
      ...
      <JsonLd
        data={[
          generateWebPageSchema(
            ...
            "Find a The Financial Architects office near you. 33 locations across California, Arizona, and Oregon.",
