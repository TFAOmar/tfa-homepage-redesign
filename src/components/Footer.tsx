        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/advisor-onboarding" className="text-primary-foreground/80 hover:text-gold transition-colors">Careers</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <div>
                  <a href="tel:+18778324872" className="text-primary-foreground/80 hover:text-gold transition-colors">(877) 832-4872</a>
