  ...
  return `
    ...
    <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f4f4;">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ${advisorName ? `
        <tr>
          <td style="padding: 16px 24px; background-color: #B91C1C; border-bottom: 3px solid #7F1D1D;">
            <p style="margin: 0; color: #ffffff; font-size: 15px; font-weight: 700; letter-spacing: 0.5px; text-transform: uppercase;">
              ⚠ Do Not Contact
            </p>
            <p style="margin: 6px 0 0 0; color: #FEE2E2; font-size: 13px; line-height: 1.5;">
              This lead was generated by <strong style="color:#ffffff;">${advisorName}</strong> and will be handled directly by them. Logged to the Leads Inbox for tracking only — please do not reach out to the prospect.
            </p>
          </td>
        </tr>
        ` : ''}
