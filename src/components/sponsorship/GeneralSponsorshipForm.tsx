                ...
                {!submittedLeadId ? (
                  ...
                  <div className="space-y-4">
                    <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-xl p-4 text-center">
                      <p className="text-green-800 dark:text-green-200 font-medium">✅ Inquiry submitted successfully!</p>
                      <p className="text-sm text-green-600 dark:text-green-400 mt-1">We'll follow up within 24 hours.</p>
                    </div>
