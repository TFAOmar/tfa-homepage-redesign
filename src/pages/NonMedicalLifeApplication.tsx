...
const NonMedicalLifeApplication = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Non-Medical Term Life Application{advisor ? ` - ${advisor.name}` : ""} | TFA
        </title>
        <meta
          name="description"
          content="Apply for non-medical term life insurance online. No medical exam required. Secure, confidential, and easy."
        />
      </Helmet>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <div className="hidden md:block">
                  <p className="text-sm text-muted-foreground">Non-Medical Term Life Application</p>
                  <p className="text-xs text-muted-foreground">No Medical Exam Required</p>
                </div>
              </div>
        ...
        <main className="container mx-auto px-3 md:px-4 py-4 md:py-8 pb-safe">
          <div className="text-center mb-6 md:mb-8">
            ...
            <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto px-2">
              No medical exam required. Complete this short application to get started with non-medical term life coverage.
              {advisor && (
...
export default NonMedicalLifeApplication;