...
const AdvisorElenaEsquivel = () => {
  ...
  return (
    <>
      <SEOHead
        title="Elena Esquivel | Financial Strategist & Estate Planning Consultant"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start text-white/80">
                ...
                <a href="mailto:eesquivel@tfainsuranceadvisors.com" className="flex items-center hover:text-accent transition-colors">
                  <Mail className="h-5 w-5 mr-2" />
                  eesquivel@tfainsuranceadvisors.com
                </a>
              </div>
            </div>
      ...
      <ScheduleModal
        ...
        advisorEmail="eesquivel@tfainsuranceadvisors.com"
